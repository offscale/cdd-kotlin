...
class DtoMergerTest {
  ...
  fun `mergeDto adds missing nullable field preserving existing structure`() {
    ...
    assertTrue(
        result.contains("@kotlinx.serialization.SerialName(\"email\") val email: String? = null"),
        "Missing field text incorrect")
  ...
  fun `mergeDto ignores existing fields`() {
    ...
    val schema =
        SchemaDefinition(
            ...
            type = "object",
            properties =
                mapOf("id" to SchemaProperty("integer"), "score" to SchemaProperty("integer")),
  ...
  fun `mergeDto inserts into empty constructor`() {
    ...
    val schema =
        SchemaDefinition(
            name = "Empty", type = "object", properties = mapOf("name" to SchemaProperty("string")))
  ...
  fun `mergeDto throws when class missing`() {
    ...
    val schema =
        SchemaDefinition(
            name = "Missing", type = "object", properties = mapOf("id" to SchemaProperty("string")))
