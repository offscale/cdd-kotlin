...
class ReferenceResolverTest {
  ...
  fun `resolveRefToType handles External Files`() {
    ...
    assertEquals(
        "Profile", ReferenceResolver.resolveRefToType("http://example.com/schemas/Profile.yml"))
  }
  ...
  fun `resolveRefToType handles External Files with Fragments`() {
    ...
    assertEquals(
        "Metadata",
        ReferenceResolver.resolveRefToType("http://api.com/spec.json#/components/schemas/Metadata"))
  }
