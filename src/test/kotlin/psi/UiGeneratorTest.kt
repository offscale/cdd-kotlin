  ...
  fun `generateForm creates composable with correct state mappings`() {
    val schema =
        SchemaDefinition(
            ...
            type = "object",
            properties =
                mapOf("name" to SchemaProperty("string"), "age" to SchemaProperty("integer")),
  ...
  fun `generateForm creates Submit button and reconstructs object`() {
    val schema =
        SchemaDefinition(
            ...
            type = "object",
            properties =
                mapOf("title" to SchemaProperty("string"), "price" to SchemaProperty("number")),
  ...
  fun `generateGrid implements sorting`() {
    val schema =
        SchemaDefinition(
            ...
            type = "object",
            properties =
                mapOf("id" to SchemaProperty("integer"), "amount" to SchemaProperty("number")))
  ...
  fun `generateGrid handles Arrays correctly`() {
    val schema =
        SchemaDefinition(
            ...
            type = "object",
            properties =
                mapOf("tags" to SchemaProperty(type = "array", items = SchemaProperty("string"))))
    val text = generator.generateGrid("com.ui", schema).text
