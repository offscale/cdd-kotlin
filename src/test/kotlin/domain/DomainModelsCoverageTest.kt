...
class DomainModelsCoverageTest {
  ...
  fun `instantiate core domain models`() {
    ...
    val serverVar =
        ServerVariable(default = "v1", enum = listOf("v1", "v2"), description = "API version")
    val server =
        Server(
    ...
    val example = ExampleObject(summary = "Example payload", dataValue = mapOf("id" to 1))
                    ...
                    "User" to
                        SchemaDefinition(
                            ...
                            defs =
                                mapOf(
                                    "PositiveInt" to
                                        SchemaProperty(types = setOf("integer"), minimum = 1.0)),
                            title = "User schema",
                            defaultValue = "{\"id\":1}",
                            constValue = "{\"id\":1}",
                            deprecated = true,
                            ...
                            ifSchema =
                                SchemaProperty(
                                    ...
                                    properties =
                                        mapOf(
                                            "country" to
                                                SchemaProperty("string", constValue = "US"))),
                            thenSchema =
                                SchemaProperty(
                                    types = setOf("object"),
    ...
    assertEquals(
        "https://auth.example.com/.well-known/oauth-authorization-server", scheme.oauth2MetadataUrl)
    ...
    assertEquals(
        "https://json-schema.org/draft/2020-12/schema", components.schemas["User"]?.schemaDialect)
        ...
        EndpointDefinition(
            ...
            responses =
                mapOf(
                    "400" to
                        EndpointResponse(
                            statusCode = "400", description = "Bad Request", type = "Error")))
