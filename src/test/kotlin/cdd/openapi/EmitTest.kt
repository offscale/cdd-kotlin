...
class OpenApiWriterTest { 
    ...
    private fun buildFullDefinition(): OpenApiDefinition { 
        ...
        val nestedEncoding = cdd.openapi.EncodingObject(contentType = "text/plain") 
        ...
        return OpenApiDefinition( 
            ...
            info = Info( 
                ...
                license = cdd.openapi.License(name = "Apache 2.0", identifier = "Apache-2.0"), 
