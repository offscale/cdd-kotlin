...
class UriUtilsTest {
    ...
    @Test
    fun testResolveUri() {
        assertEquals("http://example.com/path", resolveUri("http://example.com/base", "http://example.com/path"))
        ...
        assertEquals("http://example.com/base/relative", resolveUri("http://example.com/base/", "relative"))
