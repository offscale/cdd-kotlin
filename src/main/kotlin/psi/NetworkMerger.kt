...
/**
 * Service to reconcile differences between existing Code definitions and new Specification
 * definitions.
 *
 * Current Strategy: Strict Spec-Driven.
 * 1. Match endpoints by operationId.
 * 2. If found in Spec, the Spec definition overwrites the Code definition (updates
 *    interface/types).
