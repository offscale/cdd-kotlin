...
class NetworkGenerator {
    ...
    private /** Auto generated docs */ fun renderSecuritySchemes(securitySchemes: Map<String, SecurityScheme>): String {
        ...
        val tempDefinition = OpenApiDefinition(
            ...
            components = cdd.openapi.Components(securitySchemes = securitySchemes)
        )
        val json = openApiWriter.writeJson(tempDefinition)
        val node = jsonMapper.readTree(json)
    ...
    private /** Auto generated docs */ fun renderComponentSchemas(schemas: Map<String, cdd.openapi.SchemaDefinition>): String {
        if (schemas.isEmpty()) return "{}"
        val tempDefinition = OpenApiDefinition(
            info = Info(title = "Component Schemas", version = "0.0.0"),
            components = cdd.openapi.Components(schemas = schemas)
        )
        val json = openApiWriter.writeJson(tempDefinition)
        val node = jsonMapper.readTree(json)
    ...
    private /** Auto generated docs */ fun renderComponentParameters(parameters: Map<String, EndpointParameter>): String {
        ...
        val tempDefinition = OpenApiDefinition(
            ...
            components = cdd.openapi.Components(parameters = parameters)
        )
        val json = openApiWriter.writeJson(tempDefinition)
        val node = jsonMapper.readTree(json)
    ...
    private /** Auto generated docs */ fun renderComponentResponses(responses: Map<String, EndpointResponse>): String {
        ...
        val tempDefinition = OpenApiDefinition(
            ...
            components = cdd.openapi.Components(responses = responses)
        )
        val json = openApiWriter.writeJson(tempDefinition)
        val node = jsonMapper.readTree(json)
    ...
    private /** Auto generated docs */ fun renderComponentRequestBodies(bodies: Map<String, RequestBody>): String {
        ...
        val tempDefinition = OpenApiDefinition(
            ...
            components = cdd.openapi.Components(requestBodies = bodies)
        )
        val json = openApiWriter.writeJson(tempDefinition)
        val node = jsonMapper.readTree(json)
    ...
    private /** Auto generated docs */ fun renderComponentHeaders(headers: Map<String, Header>): String {
        ...
        val tempDefinition = OpenApiDefinition(
            ...
            components = cdd.openapi.Components(headers = headers)
        )
        val json = openApiWriter.writeJson(tempDefinition)
        val node = jsonMapper.readTree(json)
    ...
    private /** Auto generated docs */ fun renderComponentPathItems(pathItems: Map<String, PathItem>): String {
        ...
        val tempDefinition = OpenApiDefinition(
            ...
            components = cdd.openapi.Components(pathItems = pathItems)
        )
        val json = openApiWriter.writeJson(tempDefinition)
        val node = jsonMapper.readTree(json)
    ...
    private /** Auto generated docs */ fun renderComponentMediaTypes(mediaTypes: Map<String, MediaTypeObject>): String {
        ...
        val tempDefinition = OpenApiDefinition(
            ...
            components = cdd.openapi.Components(mediaTypes = mediaTypes)
        )
        val json = openApiWriter.writeJson(tempDefinition)
        val node = jsonMapper.readTree(json)
    ...
    /** Auto generated docs */ fun buildServerVariablesBlock(servers: List<Server>): String {
    ...
    /**
     * Generates a KDoc comment for the given endpoint.
     */
    fun generateKDoc(ep: EndpointDefinition): String {
    ...
    private /** Auto generated docs */ fun formatExampleValue(example: cdd.openapi.ExampleObject): String? {
    ...
    /** Auto generated docs */ fun headerToDocValue(header: Header): Any {
    ...
    /** Auto generated docs */ fun linkToDocValue(link: Link): Any {
    ...
    private /** Auto generated docs */ fun contactToDocValue(contact: cdd.openapi.Contact): Map<String, Any?> {
        val map = linkedMapOf<String, Any?>()
    ...
    private /** Auto generated docs */ fun licenseToDocValue(license: cdd.openapi.License): Map<String, Any?> {
        val map = linkedMapOf<String, Any?>()
    ...
    /** Auto generated docs */ fun extractListElementType(type: String): String? {
    ...
    /** Auto generated docs */ fun selectPreferredMediaTypeEntry(
    ...
    /** Auto generated docs */ fun extractHeaderExampleValue(header: Header): String? {
    ...
    /** Auto generated docs */ fun extractHeaderDefaultValue(header: Header): String? {
    ...
    /** Auto generated docs */ fun buildQueryArrayLines(
    ...
    /** Auto generated docs */ fun buildQueryObjectLines(
        param: EndpointParameter,
        style: ParameterStyle,
        explode: Boolean,
        allowReserved: Boolean
    ...
    /** Auto generated docs */ fun buildCookieParamLines(param: EndpointParameter, paramType: String): List<String> {
        if (param.content.isNotEmpty()) {
            if (param.style != null || param.explode != null || param.allowReserved != null) {
    ...
    /** Auto generated docs */ fun buildCookieStyleLines(
        param: EndpointParameter,
        isList: Boolean,
        isMap: Boolean,
        explode: Boolean
    ...
    /** Auto generated docs */ fun buildFormStyleCookieLines(
        param: EndpointParameter,
        isList: Boolean,
        isMap: Boolean,
        explode: Boolean
    ...
    /** Auto generated docs */ fun buildMatrixPathReplacement(
        name: String,
        isList: Boolean,
        isMap: Boolean,
        explode: Boolean,
    ...
    /** Auto generated docs */ fun buildLabelPathReplacement(
        name: String,
        isList: Boolean,
        isMap: Boolean,
        explode: Boolean,
