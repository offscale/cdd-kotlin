...
data class NetworkParseResult(
     ...
     */
    val webhooks: Map<String, cdd.openapi.PathItem> = emptyMap(),
    /**
...
class NetworkParser {
    ...
    private /** Auto generated docs */ fun extractWebhooks(file: KtFile): Map<String, cdd.openapi.PathItem> {
    ...
    /** Auto generated docs */ fun extractPathParamNameFromExpression(expression: String): String? {
    ...
    /** Auto generated docs */ fun parseContentType(expression: KtCallExpression): String? {
    ...
    private data class ParamExampleBundle(
        var example: cdd.openapi.ExampleObject? = null,
        val examples: MutableMap<String, cdd.openapi.ExampleObject> = mutableMapOf()
    )

    private data class ParamMeta(
        var style: cdd.openapi.ParameterStyle? = null,
    ...
    private /** Auto generated docs */ fun parseParamExampleValue(raw: String): cdd.openapi.ExampleObject {
        val trimmed = raw.trim()
        if (trimmed.startsWith("external:")) {
            return cdd.openapi.ExampleObject(externalValue = trimmed.removePrefix("external:"))
        }
        if (trimmed.startsWith("{") || trimmed.startsWith("[")) {
            ...
            if (node != null) {
                ...
                return cdd.openapi.ExampleObject(dataValue = nodeToValue(node))
            }
        }
        return cdd.openapi.ExampleObject(serializedValue = trimmed)
    }
    ...
    private /** Auto generated docs */ fun extractExternalDocs(element: org.jetbrains.kotlin.psi.KtDeclaration): cdd.openapi.ExternalDocumentation? {
        val docComment = element.docComment ?: return null
        val lines = docComment.text.split("\n").map { cleanKDocLine(it) }
        ...
        return cdd.openapi.ExternalDocumentation(url = url, description = desc)
    }
    ...
    /** Auto generated docs */ fun extractExternalDocsLine(lines: List<String>): ExternalDocumentation? {
        val explicit = lines.firstOrNull { it.startsWith("@externalDocs") }
        if (explicit != null) {
            val json = explicit.removePrefix("@externalDocs").trim()
            if (json.isEmpty()) return null
    ...
    private /** Auto generated docs */ fun extractPathItemsLine(lines: List<String>): Map<String, cdd.openapi.PathItem> {
    ...
    private /** Auto generated docs */ fun extractWebhooksLine(lines: List<String>): Map<String, cdd.openapi.PathItem> {
    ...
    private /** Auto generated docs */ fun extractComponentPathItemsLine(lines: List<String>): Map<String, cdd.openapi.PathItem> {
    ...
    /** Auto generated docs */ fun parseExampleObjectNode(node: JsonNode): ExampleObject {
    ...
    /** Auto generated docs */ fun parseAdditionalProperties(node: JsonNode?): SchemaProperty? {
        return when {
            node == null -> null
    ...
    /** Auto generated docs */ fun parseDependentRequired(node: JsonNode?): Map<String, List<String>> {
        val obj = node.asObject() ?: return emptyMap()
    ...
    private /** Auto generated docs */ fun parseParameterStyle(value: String): cdd.openapi.ParameterStyle? {
        return when (value.lowercase()) {
            "matrix" -> cdd.openapi.ParameterStyle.MATRIX
            "label" -> cdd.openapi.ParameterStyle.LABEL
            "simple" -> cdd.openapi.ParameterStyle.SIMPLE
            "form" -> cdd.openapi.ParameterStyle.FORM
            "cookie" -> cdd.openapi.ParameterStyle.COOKIE
            "spacedelimited", "space_delimited", "spaceDelimited" -> cdd.openapi.ParameterStyle.SPACE_DELIMITED
            "pipedelimited", "pipe_delimited", "pipeDelimited" -> cdd.openapi.ParameterStyle.PIPE_DELIMITED
            "deepobject", "deep_object", "deepObject" -> cdd.openapi.ParameterStyle.DEEP_OBJECT
            else -> null
        }
    }

    private /** Auto generated docs */ fun parseParamStyle(value: String?): cdd.openapi.ParameterStyle? {
