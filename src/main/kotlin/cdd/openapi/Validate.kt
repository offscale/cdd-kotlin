...
class OpenApiValidator {
    ...
    internal data class SchemaValidationState(
    ...
    private /** Auto generated docs */ fun validateSchemaInMediaType(
        media: cdd.openapi.MediaTypeObject,
        path: String,
        issues: MutableList<OpenApiIssue>,
        state: SchemaValidationState
    ) {
    ...
    /** Auto generated docs */ internal fun validateSchemaDefinition(
    ...
    /** Auto generated docs */ internal fun validateSchemaPropertyInternal(
        schema: SchemaProperty,
        path: String,
        issues: MutableList<OpenApiIssue>,
        state: SchemaValidationState,
    ...
    /** Auto generated docs */ fun validateDiscriminator(
        discriminator: cdd.openapi.Discriminator?,
     ...
     */
    private /** Auto generated docs */ fun validateInfo(info: cdd.openapi.Info, basePath: String, issues: MutableList<OpenApiIssue>) {
    ...
    private /** Auto generated docs */ fun validateContact(contact: cdd.openapi.Contact, path: String, issues: MutableList<OpenApiIssue>) {
     ...
     */
    private /** Auto generated docs */ fun validateLicense(license: cdd.openapi.License, path: String, issues: MutableList<OpenApiIssue>) {
    ...
    /** Auto generated docs */ fun validateServers(servers: List<Server>, basePath: String, issues: MutableList<OpenApiIssue>) {
    ...
    /** Auto generated docs */ fun validatePathItem(
        pathKey: String,
        item: PathItem,
        basePath: String,
        issues: MutableList<OpenApiIssue>,
    ...
    internal fun validateParameter(
     ...
     */
    fun validatePathItemParameters(
        item: PathItem,
        basePath: String,
        issues: MutableList<OpenApiIssue>,
        components: Components?
    ...
    private /** Auto generated docs */ fun hasArraySchemaOrItemSchema(media: cdd.openapi.MediaTypeObject): Boolean {
    ...
    private /** Auto generated docs */ fun validateEncodingObject(
        encoding: cdd.openapi.EncodingObject,
        path: String,
        issues: MutableList<OpenApiIssue>
    ) {
    ...
    private /** Auto generated docs */ fun validateExampleObject(
        example: cdd.openapi.ExampleObject,
        path: String,
        issues: MutableList<OpenApiIssue>,
        components: Components?
    ) {
    ...
    private /** Auto generated docs */ fun validateSecurityScheme(
        scheme: cdd.openapi.SecurityScheme,
        path: String,
        issues: MutableList<OpenApiIssue>,
        components: Components?
    ) {
    ...
    private /** Auto generated docs */ fun validateExternalDocs(
        docs: cdd.openapi.ExternalDocumentation,
        path: String,
        issues: MutableList<OpenApiIssue>
    ) {
     ...
     */
    private /** Auto generated docs */ fun detectTagCycles(tagsByName: Map<String, cdd.openapi.Tag>, issues: MutableList<OpenApiIssue>) {
    ...
    /** Auto generated docs */ fun validateCallbacks(
        callbacks: Map<String, Callback>,
        path: String,
        issues: MutableList<OpenApiIssue>,
        components: Components?
    ...
    internal fun componentKeys(components: Components?, component: String): Set<String> {
    ...
    internal fun isLocalComponentRef(refBase: String?): Boolean {
    ...
    internal fun hexToInt(ch: Char): Int {
        return when (ch) {
    ...
    private /** Auto generated docs */ fun validateSecurityRequirements(
        requirements: List<cdd.openapi.SecurityRequirement>,
        components: Components?,
        path: String,
        issues: MutableList<OpenApiIssue>
    ) {
