...
class DtoParser {
    ...
    fun parse(sourceCode: String): List<SchemaDefinition> {
        ...
        println("CLASS: " + ktClass.name + " isInt: " + ktClass.isInterface() + " isSealed: " + ktClass.isSealed())
            when {
    ...
    private fun parseSealedInterface(ktClass: KtClass, subtypes: List<SealedSubtype>): SchemaDefinition {
        println("INSIDE parseSealedInterface")
        println("CALLED PARSESEALEDINTERFACE")
        ...
        val discriminatorObj = when {
            ...
            propName != null -> cdd.openapi.Discriminator(propertyName = propName)
            else -> null
        }
        ...
        val properties = mutableMapOf<String, cdd.openapi.SchemaProperty>()
    ...
    private fun extractExternalDocs(element: org.jetbrains.kotlin.psi.KtDeclaration): cdd.openapi.ExternalDocumentation? {
        val docComment = element.docComment ?: return null
        ...
        return cdd.openapi.ExternalDocumentation(
            url = url,
            description = desc
        )
    }

    private fun extractDiscriminator(element: org.jetbrains.kotlin.psi.KtDeclaration): cdd.openapi.Discriminator? {
        ...
        return cdd.openapi.Discriminator(
    ...
    /** Auto generated docs */ fun parseAdditionalPropertiesNode(node: JsonNode?): SchemaProperty? {
        return when {
            node == null -> null
    ...
    /** Auto generated docs */ fun parseDependentRequiredNode(node: JsonNode?): Map<String, List<String>> {
        val obj = node.asObject() ?: return emptyMap()
    ...
    /** Auto generated docs */ fun parseExternalDocsNode(node: JsonNode?): cdd.openapi.ExternalDocumentation? {
    ...
    /** Auto generated docs */ fun parseDiscriminatorNode(node: JsonNode?): cdd.openapi.Discriminator? {
        val obj = node.asObject() ?: return null
        return cdd.openapi.Discriminator(
    ...
    /** Auto generated docs */ fun parseXmlNode(node: JsonNode?): Xml? {
        val obj = node.asObject() ?: return null
        return Xml(
            name = obj.text("name"),
    ...
    /** Auto generated docs */ fun parseDocLiteral(raw: String): Any? {
