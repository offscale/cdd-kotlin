...
class MainTest {
    ...
    fun testToSdk() {
        try {
            ...
            assertTrue(e.message?.contains("preopened") == true || e.toString().contains("preopened") || e.message?.contains("No such file") == true, "Expected preopened directory error or similar from WASI")
        }
    }
